...
export default function ProjectsShowCaseSection() {
  ...
  return (
    <Box as='section' variant='fade'  className='flex flex-col relative z-10 snap-x snap-mandatory snap-end overflow-x-scroll scrollbar-hide -mt-52'>
        ...
        <ul className='w-full h-full flex items-center gap-20 flex-nowrap px-10 py-40 '>
